...
#warning The Xapian library was built with clang++ 13.1.6 (clang-1316.0.21.2.5)
#else
...
#error The Xapian library was built with clang++ 13.1.6 (clang-1316.0.21.2.5)
#endif
#endif
